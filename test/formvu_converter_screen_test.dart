...
void main() {
  group('FormVu converter screen widget test', () {
    ...
    testWidgets(
        'test if type in non-number in img scale text field, snackbar shows up',
        (tester) async {
      await tester.pumpWidget(createHomeScreen());
      await tester.enterText(find.byKey(Key('imgScaleTextField')), 'a');
      await tester.pumpAndSettle(const Duration(seconds: 1));
    ...
    testWidgets('test if border color picker shows up and is clickable',
        (tester) async {
      await tester.pumpWidget(createHomeScreen());
    ...
    testWidgets('test if background color picker shows up and is clickable',
        (tester) async {
      await tester.pumpWidget(createHomeScreen());
