              ...
              children: [
                Column(
                  ...
                  children: [
                    ...
                    StyledText(
                        text:
                            "This converter can convert PDF to standalone HTML content or SVG. It’s powered by our product BuildVu."),
                    SizedBox(
                      height: h * 0.02,
                    ),
                    StyledText(
                    ...
                    StyledText(
                        text:
                            "BuildVu is used by companies across a range of industries that includes publishing, education, finance, aerospace, recruitment, supply chain, government, healthcare, maritime and lots, lots more."),
                  ],
                ),
                SizedBox(
                  height: h * 0.04,
                ...
                Column(
                  ...
                  children: [
                    ...
                    StyledText(
                        text:
                            "This converter can convert fillable PDF to HTML content. It’s powered by our product FormVu."),
                    SizedBox(
                      height: h * 0.02,
                    ),
                    StyledText(
                        text:
                            "While BuildVu can handle most interactive annotations, if you are looking to let your users fill in PDF forms on the website, FormVu is a closer fit to your needs."),
                    SizedBox(
                      height: h * 0.02,
                    ),
                    StyledText(
                        text:
                            "Similar to BuildVu, FormVu is also a Java application that can be used from command line or as a simple micro-service, and can run on cloud or physical servers. With FormVu, you can easily integrate conversion into your apps, giving users on any browsers the same experience while filling out forms."),
                  ],
                ),
                SizedBox(
                  height: h * 0.04,
