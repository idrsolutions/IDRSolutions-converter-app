                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        ...
                        StyledText(
                            text:
                                'This free mobile converter is powered by Buildvu. BuildVu is a document conversion SDK that allows developers to build HTML5 solutions that work with PDF files.'),
                        SizedBox(height: h * 0.03),
                        StyledTitleBuildVu(
                            key: Key('businessRequirement'), // for testing
                            text:
                                'Business requirement to display PDF in the web browser?'),
                      ],
                    ),
                    SizedBox(height: h * 0.03),
                    ColorfulBgBtn(
