...
// default
final buildvuOriginalFileProvider =
    NotifierProvider<BuildVuOriginalFileNotifier, BuildVuOriginalFile>(() {
...
// default
final formvuOriginalFileProvider =
    NotifierProvider<FormVuOriginalFileNotifier, FormVuOriginalFile>(() {
...
class ConvertedFileNotifier extends Notifier<ConvertedFile> {
  ...
  void updateFile({String? previewURL, String? downloadURL}) {
    // update the file
    state = state.copyWith(
...
// default
final convertedFileProvider =
    NotifierProvider<ConvertedFileNotifier, ConvertedFile>(() {
